...
void Application::update()
{
	...
	transform2 = glm::translate(glm::mat4(1.0f), glm::vec3(0.5f, 0.0f, 0.0f));
	transform2 = transform2 * transform;

	transform3 = glm::translate(glm::mat4(1.0f), glm::vec3(-0.5f, 0.0f, 0.0f));
...
void Application::display()
{
	...
	glUniformMatrix4fv(idTransform, 1, GL_FALSE, glm::value_ptr(transform3));
	glDrawArrays(GL_TRIANGLES, 0, triangle.numVertex);
}
